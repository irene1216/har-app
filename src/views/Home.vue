<template>
    <div class="home">
        <transition appear appear-active-class="first-enter-active">
            <side-bar :brand="sideLogo" :handleLogo="handleLogo" :handleSocial="handleSocial" />
        </transition>
        <transition appear appear-active-class="first-enter-active">
        ...
        <div class="section beige-bg">
            <div class="container">
                <div class="tabs">
                    <products :products="products" :activeId="activeId" :display="display" :handleProductImg="handleProductImg" :handleProductYellow="handleProductYellow" @show:product="showProduct" @productUpdate="productUpdate" class="product-tabs" />
                </div>
            </div>
        </div>
        <!-- Contact -->
